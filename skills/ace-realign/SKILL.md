...
description: >
  ...
  surface (CLAUDE.md, a skill, an explicit earlier instruction). DO NOT TRIGGER
  for first-time rule capture with no prior violation, or when the user merely
  disagrees with an output rather than citing a broken rule.
---
